...
If you find a security vulnerability in LeJEPA_Cotton_Field_Assessment, please report it through [GitHub's private vulnerability reporting](https://github.com/Akintanoreofe/LeJEPA_Cotton_Field_Assessment/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact oreofeakintan@gmail.com for details.
